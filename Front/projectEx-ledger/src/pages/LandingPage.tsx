...
import MiniConverter from '../components/widgets/finance/MiniConverter';
import ExchangeRateTable from '../components/widgets/finance/ExchangeRateTable';

// 차트 컴포넌트 지연 로딩 (Code Splitting)
const ExchangeRateChart = lazy(() => import('../components/widgets/finance/ExchangeRateChart'));
